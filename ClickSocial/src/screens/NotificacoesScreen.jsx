...
export default function NotificacoesScreen({ aoNavegarAba }) {
  const renderizarIcone = (tipo) => {
    switch (tipo) {
      case "curtida":
        return <Ionicons name="heart" size={32} color="#FF0000" />;
      case "comentario":
        return <Ionicons name="chatbubble" size={28} color="#1E90FF" />;
      case "seguir":
        return <Feather name="user-plus" size={28} color="#000000" />;
      default:
